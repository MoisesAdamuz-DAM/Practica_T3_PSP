...
public ClienteChar(Socket socket, String nombre)
{
	...
	//Envía mensaje de conexción al cliente
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == boton) {
			...
			try {
				mensaje.setText("");
				fsalida.writeUTF(texto);
				//Bloqueamos el botón una vez pulsado 
				boton.setEnabled(false);
				//El botón permanecerá bloqueado 3 segundos
				Thread.sleep(3000);
				//Pasado esos 3 segundos, el botón se desbloqueará
